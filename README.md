...
Existe uma versão em https://bufunfa.jnogueira.net.br, rodando em containers do [Docker](https://www.docker.com) em uma máquina com 1 GB de memória, 25 GB de disco com Ubuntu 18.04, sendo que:
